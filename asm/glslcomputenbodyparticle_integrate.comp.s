...
%gl_WorkGroupSize = OpConstantComposite %v3uint %uint_256 %uint_1 %uint_1
   ...
   %velocity = OpVariable %_ptr_Function_v4float Function
         ...
         %41 = OpLoad %float %40
         %42 = OpLoad %v4float %velocity
         %43 = OpVectorTimesScalar %v4float %42 %41
         %44 = OpLoad %v4float %position
         %45 = OpFAdd %v4float %44 %43
               OpStore %position %45
         %46 = OpLoad %int %index
         %47 = OpLoad %v4float %position
         %48 = OpAccessChain %_ptr_Uniform_v4float %_ %int_0 %46 %int_0
               OpStore %48 %47
               OpReturn
               OpFunctionEnd
