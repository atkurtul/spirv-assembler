   ...
   %kernel_0 = OpVariable %_ptr_Function__arr_float_uint_9 Function
    ...
    %param_2 = OpVariable %_ptr_Function_float Function
        ...
        %152 = OpLoad %_arr_float_uint_9 %151
               OpStore %param_0 %152
               OpStore %param_1 %float_0_100000001
        ...
        %160 = OpCompositeConstruct %v4float %157 %158 %159 %float_1
               OpStore %res_0 %160
        %162 = OpLoad %79 %resultImage
        %164 = OpLoad %v3uint %gl_GlobalInvocationID
        %165 = OpVectorShuffle %v2uint %164 %164 0 1
        %166 = OpBitcast %v2int %165
        %167 = OpLoad %v4float %res_0
               OpImageWrite %162 %166 %167
               OpReturn
               OpFunctionEnd
